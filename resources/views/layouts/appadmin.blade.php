...
<script type="text/javascript" src="{{ asset('//netdna.bootstrapcdn.com/bootstrap/3.2.0/js/bootstrap.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('//code.jquery.com/jquery-1.11.1.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('dashboard.jss') }}"></script>
